...
class WebODM_API:
        ...
        try:
            if hasattr(self, 'mydb') and self.mydb:
                try:
                    ...
                    print(f"ReferenceError closing database connection: {e}", file=sys.stderr)
                except Exception as e:
    ...
    def get_cracks(self):
        ...
        start_row = 34
        end_row = 45
        columns = ["center_lat", "center_long", "center_alt", "box_length", "box_width", "box_height", "uid"]  # Replace with your actual column names
